...
<div class="text-center">
    <a href="{{ route('showLibros') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded-lg transition duration-300 transform hover:scale-105 ease-in-out mt-4 no-underline">Ver Todos los Libros</a>
</div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white border rounded-lg shadow overflow-hidden">
            ...
            <tbody class="divide-y divide-gray-200">
                @each('components.table', $libros, 'item')
            </tbody>
        </table>
    </div>
    @endif
