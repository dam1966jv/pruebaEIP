...
<div class="flex items-center justify-center mt-10">
    <div class="bg-white p-8 rounded-lg shadow-lg w-96 mt-10">
        ...
        <form method="POST" action="{{ route('store') }}">
            ...
            <div class="mb-4">
               <label for="user_id" class="block text-sm font-medium text-gray-700">Selecciona un Usuario:</label>
              <select class="form-select mt-1 block w-full" id="user_id" name="user_id">
