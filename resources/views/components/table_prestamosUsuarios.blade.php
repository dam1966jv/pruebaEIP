...
<tr class="hover:bg-gray-100 border-t border-gray-200">
    ...
    <td class="px-4 py-2">
    <a href="http://localhost/updatePrestamoFormUsuario/{{ $item->id }}" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-1 px-2 rounded-full inline-block">Modificar</a>
</td>
